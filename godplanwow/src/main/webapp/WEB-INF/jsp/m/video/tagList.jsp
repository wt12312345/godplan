			...
			<div class="body-page-main-ctn">
				<div class="main-title">
					...
					<div class="main-title-btn">
						<a class="btn btn-primary" href="${path}m/video/tagEdit"><i
				...
				if (data.code == 1) {
					...
					for (var i = 0; i < listItem.length; i++) {
						...
						html += '<tr><td>' + item.id + '</td><td>' + item.name
								+ '</td><td><a class="btn btn-primary btn-xs" href="${path}m/video/tagEdit?id='
