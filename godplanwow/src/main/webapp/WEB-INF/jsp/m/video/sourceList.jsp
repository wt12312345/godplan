...
<body>
			...
			<div class="body-page-main-ctn">
				<div class="main-title">
					...
					<div class="main-title-btn">
						<a class="btn btn-primary" href="${path}m/video/sourceEdit"><i
	...
	<script>
		$(function() {
			var listItem = [];
			$.post('${path}m/video/getSourceList',
			function(data) {
				if (data.code == 1) {
					listItem = data.obj;
					for (var i = 0; i < listItem.length; i++) {
						...
						html += '<tr><td>' + item.id + '</td><td>' + item.name
								+ '</td><td><a class="btn btn-primary btn-xs" href="${path}m/video/sourceEdit?id='
